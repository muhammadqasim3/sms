        ...
        @foreach($classAssignings as $classAssigning)
            ...
            <td>{{ $classAssigning->time_id }}</td>
                <td width="120">
                    ...
                    <div class='btn-group'>
                        <a href="{{ route('classAssignings.show', [$classAssigning->id]) }}" class='btn btn-default btn-xs'>
                            <i class="far fa-eye"></i>
                        </a>
                        <a href="{{ route('classAssignings.edit', [$classAssigning->id]) }}" class='btn btn-default btn-xs'>

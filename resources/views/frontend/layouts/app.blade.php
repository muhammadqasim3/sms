...
<div class="wrapper">
  <div id="slider">
    <div id="slide-wrapper" class="rounded clear"> 
      ...
      <figure id="slide-2"><a class="view" href="#"><img src="{{ asset('frontend/images/demo/slider/2.png') }}" alt=""></a>
        <figcaption>
      ...
      <figure id="slide-3"><a class="view" href="#"><img src="{{ asset('frontend/images/demo/slider/3.png') }}" alt=""></a>
        <figcaption>
          <h2>Aliquatjusto quisque nam</h2>
          <p>Attincidunt vel nam a maurisus lacinia consectetus magnisl sed ac morbi. Inmaurisus habitur pretium eu et ac vest penatibus id lacus parturpis.</p>
          <p class="right"><a href="#">Continue Reading &raquo;</a></p>
      ...
      <figure id="slide-4"><a class="view" href="#"><img src="{{ asset('frontend/images/demo/slider/4.png') }}" alt=""></a>
        <figcaption>
          <h2>Aliquatjusto quisque nam</h2>
          <p>Attincidunt vel nam a maurisus lacinia consectetus magnisl sed ac morbi. Inmaurisus habitur pretium eu et ac vest penatibus id lacus parturpis.</p>
          <p class="right"><a href="#">Continue Reading &raquo;</a></p>
      ...
      <figure id="slide-5"><a class="view" href="#"><img src="{{ asset('frontend/images/demo/slider/5.png') }}" alt=""></a>
        <figcaption>
      ...
      <div class="group btmspace-30"> 
        ...
        <div class="one_half"> 
          ...
          <ul class="nospace listing">
            <li class="clear">
              <div class="imgl borderedbox"><img src="{{ asset('frontend/images/demo/120x120.gif') }}" alt=""></div>
        ...
        <div class="one_quarter sidebar"> 
          ...
          <div class="sdb_holder">
            ...
            <ul class="nospace quickinfo">
              <li class="clear"><a href="#"><img src="{{ asset('frontend/images/demo/80x80.gif') }}" alt=""> Make An Application</a></li>
